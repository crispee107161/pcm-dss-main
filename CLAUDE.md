...
4. **AI features** — `actions/chat.ts` and `actions/categorize.ts` (ALG-05 LLM categorisation) call the Groq API. (`actions/ai-insights.ts` and `components/analytics/AIInsightCard.tsx` were dead code tracing back to the cut predictive regression and were deleted 2026-09-02.)
