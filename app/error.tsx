      ...
      <div className="flex w-full max-w-sm flex-col gap-6">
        ...
        <div className="rounded-xl border bg-card p-6 shadow-border-lg text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-3">
            ...
            <Link
              href="/login"
              className="inline-flex h-9 items-center justify-center rounded-md bg-primary px-4 text-sm font-medium text-white transition-colors hover:bg-[var(--primary-hover)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              Go to Dashboard
            </Link>
          </div>
