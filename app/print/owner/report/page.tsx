              ...
              <tbody>
                {monthlyData.map(row => (
                  <tr key={row.period}>
                    ...
                    <td className={`${reportTdRight} hidden sm:table-cell`}>{row.purchases > 0 ? formatPHP(row.spend / row.purchases) : '—'}</td>
                  </tr>
                ))}
                {(() => {
                  ...
                  return (
                    <tr className={reportTotalRow}>
                      ...
                      <td className={`${reportTdRight} hidden sm:table-cell`}>{mPurchases > 0 ? formatPHP(mSpend / mPurchases) : '—'}</td>
                    </tr>
                  )
                })()}
              </tbody>
