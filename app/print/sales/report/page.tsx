        ...
        <ReportSection title="Key Insights">
          <ul className="space-y-2 text-sm text-gray-100">
            ...
            {totalImpressions > 0 && totalLinkClicks > 0 && (
              <li className="flex gap-2">
                <span className="text-gray-400 mt-0.5">—</span>
                Overall link click-through rate: <strong className="text-gray-25">{((totalLinkClicks / totalImpressions) * 100).toFixed(2)}%</strong> ({totalLinkClicks.toLocaleString()} clicks / {totalImpressions.toLocaleString()} impressions)
              </li>
            )}
