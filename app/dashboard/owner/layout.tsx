...
const navItems: NavItem[] = [
  ...
  { section: 'Content',         label: 'Content Library',       href: '/dashboard/owner/content',            icon: 'folder' },
  {                             label: 'Categorization Review',  href: '/dashboard/owner/categorize',         icon: 'tag' },
  ...
  // not campaigns; see its PageHeader copy, unchanged. Icon matches the
  // Marketing nav's "Top Ads" item (same page, shared label).
