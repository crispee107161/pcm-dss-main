...
export default async function OwnerSimulationPage() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      {/* Budget Allocator */}
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8">
        <h2 className="text-lg font-semibold text-slate-800 mb-1">Budget Allocation Recommender</h2>
        <p className="text-sm text-slate-400 mb-5">Distribute a total budget across your best-performing ad sets based on historical efficiency.</p>
        <BudgetAllocator />
      </div>
