...
- **FR-15 manual ground-truth labelling itself** — the import pipeline and comparison UI are built and live, but the actual two-coder, 150–200-post labelling pass (mvp.md §9 item 3) hasn't been run yet; `groundTruth.n === 0` is the current live state until that lands.
