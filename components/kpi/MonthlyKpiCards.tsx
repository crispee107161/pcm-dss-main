        ...
        <div key={kpi.period}
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-4xl font-bold text-gray-900 tracking-tight tabular">{formatPhp(kpi.total_spend)}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <p className="text-lg font-bold text-green-500 tabular">{formatNumber(kpi.total_purchases)}</p>
              </div>
              <div>
                <div className="flex items-center gap-1.5 mb-0.5">
                ...
                <p className="text-lg font-bold text-gray-700 tabular">{formatNumber(kpi.total_reach)}</p>
              </div>
            </div>
          </div>
        </div>
