        ...
        <table className="w-full text-sm">
          <thead>
            <tr>
              ...
              <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider px-4 py-3 bg-slate-50 hidden sm:table-cell">
                Strength
              </th>
              <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider px-4 py-3 bg-slate-50">
          ...
          <tbody>
            {rows.map((row) => (
              <tr key={row.variable}>
                ...
                <td className="px-4 py-3 border-t border-slate-100 hidden sm:table-cell">
