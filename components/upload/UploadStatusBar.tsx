...
export default function UploadStatusBar() {
  ...
  return (
    <div className="fixed bottom-5 right-20 z-50 flex items-center gap-3 bg-slate-900 text-white text-sm px-4 py-3 rounded-xl shadow-2xl shadow-black/30 border border-slate-700">
      ...
      <span>
        ...
        file{total !== 1 ? 's' : ''}
        {inFlight > 0 && <span className="text-slate-400"> — {inFlight} remaining</span>}
      </span>
    </div>
  )
}
