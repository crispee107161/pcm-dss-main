      ...
      <table className="w-full text-sm">
        <thead>
          <tr>
            ...
            <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider px-4 py-3 bg-slate-50 hidden sm:table-cell">Inserted</th>
            <th className="text-left text-xs font-medium text-slate-500 uppercase tracking-wider px-4 py-3 bg-slate-50 hidden sm:table-cell">Updated</th>
        ...
        <tbody>
          {logs.map((log) => (
            <tr key={log.id}>
              ...
              <td className="px-4 py-3 text-slate-700 border-t border-slate-100 text-center hidden sm:table-cell">
